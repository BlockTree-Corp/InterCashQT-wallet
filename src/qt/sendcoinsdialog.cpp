    ...
    model(0)
{
	...
	ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a InterCash address (e.g. CfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ...
    QAction *clipboaMCChangeAction = new QAction(tr("Copy change"), this);
    ...
    connect(clipboaMCChangeAction, SIGNAL(triggered()), this, SLOT(coinControlClipboaMCChange()));
    ...
    ui->labelCoinControlChange->addAction(clipboaMCChangeAction);
...
void SendCoinsDialog::coinControlClipboaMCChange()
{
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->style()->polish(ui->labelCoinControlChangeLabel);
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid InterCash address"));
        }
        else
        {
