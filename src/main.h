...
static const int LAST_POW_BLOCK = 51840000; //about 100 Years of PoW blocks
...
static const int64_t MAX_MONEY = 3500000000 * COIN;
static const int64_t MAX_MINT_PROOF_OF_STAKE = 1 * CENT; // 5% per year
...
static const uint256 hashGenesisBlock("0x000002e3d3f54156d66d6d1822f9b5bbd4450329afc102693ce3dacaf034f1dc");
static const uint256 hashGenesisBlockTestNet("0x000002e3d3f54156d66d6d1822f9b5bbd4450329afc102693ce3dacaf034f1dc");
...
public:
    ...
    {
        // InterCash: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // InterCash: get transaction coin age
...
public:
    ...
    // InterCash: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // InterCash: two types of block: proof-of-work or proof-of-stake
    ...
    // InterCash: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // InterCash: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // InterCash: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // InterCash: block index flags
    enum  
    {
