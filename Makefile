#############################################################################
# Makefile for building: InterCash-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ? 3 2 15:44:14 2018
# Project:  InterCash.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile InterCash.pro
#############################################################################
...
Makefile: InterCash.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile InterCash.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/InterCash/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/InterCash/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/InterCash/src/leveldb/libleveldb.a: FORCE
