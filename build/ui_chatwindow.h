...
public:
    ...
    void retranslateUi(QWidget *ChatWindowClass)
    {
        ...
        label_9->setText(QApplication::translate("ChatWindowClass", "<html><head/><body><p align=\"center\"><span style=\" font-size:20px; font-weight:600; color:#000000;\">InterCash IRC Chat</span></p></body></html>", 0, QApplication::UnicodeUTF8));
